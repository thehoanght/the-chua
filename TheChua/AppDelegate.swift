...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let navBarColor = UIColor(red:0.29, green:0.30, blue:0.36, alpha:1.0)
        UINavigationBar.appearance().barTintColor = navBarColor
        UINavigationBar.appearance().tintColor = UIColor.whiteColor()
        
        
        //        let tabBarColor = UIColor.whiteColor()
...
//        // pod 'GoogleAnalytics'
//        let tracker = GAI.sharedInstance().trackerWithTrackingId("UA-79285121-1")
...
//        }
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        if let token = UserInfo.stringForKey("Token") {
            ...
            PostMethod().pushString(LinkServe().PushDeviceToken, postString: "token=\(token)&devicetoken=\(tokenString)")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "hoangdao.sadsdsa" in the application's documents Application Support directory.
